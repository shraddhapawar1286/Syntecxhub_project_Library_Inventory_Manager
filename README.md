...
Book class – stores details like book ID, title, author, and status.
Library class – manages all book operations.
It uses lists and dictionaries (HashMap-like structure) for quick searching and data management. The program also stores book records in a JSON file, so the data is saved permanently and reloaded when the program starts again.
Additionally, the system can generate simple reports such as:
...
![library](https://github.com/user-attachments/assets/2e5f9ac8-1082-4ecd-9283-9a6adf47f0b2)
